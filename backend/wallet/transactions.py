...
class Transactions:
    ...
    @staticmethod
    def transaction_reward(miner_wallet):
        """
        This method is called whenever a new block is mined.
        The miner's wallet will get the mining reward with the input being the address of the mining reward provider.
        """
        output = {}
    ...
    def verify_transaction(transaction):
        #verify the transactions when it contains rewards
